...
import { House, PackageSearch, NewspaperIcon, PanelTop, SquareChartGantt } from "lucide-react"
...
const navigation2 = [
  ...
  },
  {
    ...
    children: [
      {
        name: "Graficas",
        href: "/noticias/monitoring",
        active: false,
      },
      {
        name: "Tablas",
        href: "/noticias/tablas",
        active: false,
      },
      {
        name: "Extra",
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="block text-xs text-gray-900 dark:text-gray-50">
              Santiago Emiliano Cheluja Martin
            </span>
          </div>
        </div>
      </SidebarHeader>
